...
//         {/* Priority Slider - Using TextInput as replacement */}
...
//               <Button
//                 key={priority}
//                 mode={event.priority === priority ? 'contained' : 'outlined'}
//                 onPress={() => onUpdate({ ...event, priority })}
...
//         <List.AccordionGroup>
//           <List.Accordion title={`Events (${(formData.form2.events || []).length})`} id="events">
...
//           <List.Accordion title="Timeline Summary" id="summary">
