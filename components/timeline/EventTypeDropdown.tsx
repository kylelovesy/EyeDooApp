...
import { eventTypeDetails, getEventTypeDetails } from '../../constants/eventTypes';
import { useAppTheme } from '../../constants/theme';
import type { EventTypeDropdownProps } from '../../types/timeline';
      ...
      <Menu
        ...
        anchor={
          <Button
            ...
            disabled={disabled}
            style={[error && { borderColor: theme.colors.onBackground, borderRadius: theme.roundness }]}
