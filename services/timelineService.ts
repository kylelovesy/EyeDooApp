...
// export const convertToFormData = (firestoreEvent: TTimelineEvent): TTimelineEventForm => ({
//   ...firestoreEvent,
//   time: firestoreEvent.time.toDate()
// });

// export const convertToFirestoreData = (formEvent: TTimelineEventForm): TTimelineEvent => ({
//   ...formEvent,
//   time: Timestamp.fromDate(formEvent.time)
// });
...
//       // FIX: The original function was not saving the document.
//       const projectRef = doc(db, 'projects', projectId);
//       await updateDoc(projectRef, {
//         'timeline.events': arrayUnion(newEventForFirestore)
//       });
      
//       console.log('Timeline event added with ID:', newEventForFirestore.eventId);
//       return event; // Return the original form event for immediate UI update
//     } catch (error) {
//       console.error('Error adding timeline event:', error);
//       throw error;
...
//       await updateDoc(docToUpdateRef, finalUpdates);
//     } catch (error) {
//       console.error('Error updating timeline event:', error);
//       throw error;
//     }
