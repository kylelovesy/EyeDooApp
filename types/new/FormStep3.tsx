    ...
    <Card style={styles.personCard}>
      <Card.Content>
        ...
        <Dropdown
          ...
          onSelect={(value) => onUpdate({ ...person, relationshipToCouple: value as RelationshipToCouple })}
    ...
    <Card style={styles.personCard}>
      <Card.Content>
        ...
        <Dropdown
          ...
          onSelect={(value) => onUpdate({ ...person, typeOfContact: value as ContactType })}
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.content}>
        ...
        <View style={styles.sectionHeader}>
          <Text>Immediate Family ({(formData.form3.immediateFamily || []).length})</Text>
          <Button
            mode="contained"
        ...
        {/* Extended Family */}
        <View style={styles.sectionHeader}>
          <Text>Extended Family ({(formData.form3.extendedFamily || []).length})</Text>
          <Button
            mode="contained"
        ...
        {/* Wedding Party */}
        <View style={styles.sectionHeader}>
          <Text>Wedding Party ({(formData.form3.weddingParty || []).length})</Text>
          <Button
            mode="contained"
        ...
        {/* Other Key People */}
        <View style={styles.sectionHeader}>
          <Text>Other Key People ({(formData.form3.otherKeyPeople || []).length})</Text>
          <Button
            mode="contained"
