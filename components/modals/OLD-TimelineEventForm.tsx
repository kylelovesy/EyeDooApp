  ...
  const [savedEvents, setSavedEvents] = useState<TTimelineEventForm[]>([
    {
      ...
      description: 'Wedding ceremony with family and friends at St. Mary\'s Church',
      notification: 'Push',
      status: 'Draft',
    },
    {
      ...
      description: 'First dance as married couple in Reception Hall',
      notification: 'None',
      status: 'Draft',
    },
    {
    ...
    },
    {
      ...
      description: 'Couple portraits after ceremony in Garden Area',
      notification: 'None',
      status: 'Draft',
    },
    {
