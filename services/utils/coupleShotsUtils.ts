...
import { TCoupleShotsChecklistItem } from '../../types/coupleShotsChecklist';

export function generatePredefinedCoupleShots(categories: any[]): TCoupleShotsChecklistItem[] {
  const shots: TCoupleShotsChecklistItem[] = [];
